<template>
  <div class="home">
    <!-- Hero Section -->
    <section class=" flex flex-col md:flex-row items-center container mx-auto py-12 gap-12 px-6">
      <div class="md:w-1/3 w-full relative">
        <div class=" bg-surface-container round overflow-hidden shadow-2xl relative z-10">
      ...
      <div class="md:w-2/3 w-full flex flex-col items-start gap-8 z-10">
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          <router-link v-for="art in store.highlightedArtworks" :key="art.id" :to="'/artwork/' + art.id" class="group block">
            <div class="aspect-[3/4] overflow-hidden round bg-surface-container mb-4 shadow-sm group-hover:shadow-md transition-shadow duration-300">
